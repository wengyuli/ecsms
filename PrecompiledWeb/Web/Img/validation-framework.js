 ...
 * $Id: validation-framework.js,v 1.5 2007/12/19 08:52:15 zczhang Exp $
 */
...
// instead.
var ValidationRoot = "/includes/js/validation/";
...
ValidationFramework.validateDepend = function(field, depend) {
	...
	} else if (depend.getName() == "number") {
		return ValidateMethodFactory.validateNumber(field, depend.getParams());
	...
	} else if (depend.getName() == "numberGreatField") {
		return ValidateMethodFactory.validateNumberGreatField(field, depend.getParams());
	} else if (depend.getName() == "numberLessField") {
		return ValidateMethodFactory.validateNumberLessField(field, depend.getParams());
	} else if (depend.getName() == "dateGreatField") {
		return ValidateMethodFactory.validateDateGreatField(field, depend.getParams());
	} else if (depend.getName() == "dateLessField") {
		return ValidateMethodFactory.validateDateLessField(field, depend.getParams());
	} else if( depend.getName() == "mobile") {
		return ValidateMethodFactory.validateMobile(field, depend.getParams());
	}
	else {
...
ValidationFramework.getErrorString = function(field, depend) {
	...
	} else if ( dep == "equalsfield" || dep == "numbergreatfield" || dep == "numberlessfield" || dep == "dategreatfield" || dep == "datelessfield") {
...
ValidateMethodFactory.validateNumber = function(field, params) {
	if(ValidateMethodFactory.validateInteger(field, params)) {
		return true;
	}else {
		return ValidateMethodFactory.validateDouble(field, params);
	}
}
...
ValidateMethodFactory.validateChineseChar = function(field, params) {
	...
	if (obj == null) return false;
	if (obj.value == "") return true;
	var exp = new RegExp("^[A-Za-z0-9_\u4E00-\u9FA5\uF900-\uFA2D]*$");
	return exp.test(obj.value);
}
...
ValidateMethodFactory.validateNumberGreatField = function(field, params) {
	var obj = ValidationFramework.getWebFormFieldObj(field);
	if (obj == null) return false;
	var formObj = document.getElementById(ValidationFramework._currentForm.getId());
	var eqField = formObj[params[0]];
	if (eqField != null) {
		...
		try {
			...
			value2 = parseFloat(eqField.value)
...
ValidateMethodFactory.validateNumberLessField = function(field, params) {
	var obj = ValidationFramework.getWebFormFieldObj(field);
	if (obj == null) return false;
	var formObj = document.getElementById(ValidationFramework._currentForm.getId());
	var eqField = formObj[params[0]];
...
ValidateMethodFactory.validateDateGreatField = function(field, params) {
	var obj = ValidationFramework.getWebFormFieldObj(field);
	if (obj == null) return false;
	var formObj = document.getElementById(ValidationFramework._currentForm.getId());
	var eqField = formObj[params[0]];
	...
	if (eqField != null) {
		...
		var value2;
		try {
			value1 = new Date(obj.value.replace(/[-]+/g, "/"))
			value2 = new Date(eqField.value.replace(/[-]+/g, "/"))
...
ValidateMethodFactory.validateDateLessField = function(field, params) {
	var obj = ValidationFramework.getWebFormFieldObj(field);
	if (obj == null) return false;
	var formObj = document.getElementById(ValidationFramework._currentForm.getId());
	var eqField = formObj[params[0]];
...
ValidateMethodFactory.validateMobile = function(field, params) {
	var obj = ValidationFramework.getWebFormFieldObj(field);
	if (obj == null) return false;
	if (obj.value == "") return true;
...
ValidationErrorString["zh-cn"]["chinesechar"] = "{0}必须是中文字符，字母，数字和下划线。";
...
ValidationErrorString["zh-cn"]["numbergreatfield"]="{0}必须大于{1}。";
ValidationErrorString["zh-cn"]["numberlessfield"]="{0}必须小于{1}。";
ValidationErrorString["zh-cn"]["dategreatfield"]="{0}必须大于等于{1}。";
ValidationErrorString["zh-cn"]["datelessfield"]="{0}必须小于等于{1}。";
ValidationErrorString["zh-cn"]["number"]="{0}必须是一个数字";
ValidationErrorString["zh-cn"]["mobile"]="{0}不合法";
...
ValidationErrorString["en-us"]["numbergreatfield"]="{0} should be great than {1}.";
ValidationErrorString["en-us"]["numberlessfield"]="{0} should be less than {1}.";
ValidationErrorString["en-us"]["dategreatfield"]="{0} should be great than {1}.";
ValidationErrorString["en-us"]["datelessfield"]="{0} should be less than {1}.";
ValidationErrorString["en-us"]["number"]="{0} should be a number.";
